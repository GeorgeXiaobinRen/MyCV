...
\begin{itemize}[leftmargin=*,nosep]
    ...
    \item Instituter: Prof. Wenfan Yi
...
\begin{itemize}[leftmargin=*,nosep]
    ...
    \item Position: Team member
    \item Instituter: Prof. Benny Y. C. Hon
    \item Responsibilities:
    \begin{itemize}[leftmargin=*,nosep]
        ...
        \item Considered applying Monte Carlo sampling to different problems (especially the high-dimensional problems)
    \end{itemize}
\end{itemize}
